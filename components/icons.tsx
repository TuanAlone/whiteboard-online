...
export const ViewfinderIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 10h18M3 14h18m-9-4v8m-7-4h.01M21 12h- .01M12 3v.01M12 21v-.01M4 4l1.5 1.5M18.5 5.5L20 4M4 20l1.5-1.5M18.5 18.5L20 20" />
    </svg>
);
...
export const EraserIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.5 2.5l-6 6l11 11l6-6zM5 8l4 4"
    />
  </svg>
);
...
export const SelectionIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 4h16v16H4z" strokeDasharray="4 4" />
  </svg>
);
...
export const DashedLineIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 20L20 4" strokeDasharray="4 4" />
    </svg>
);
